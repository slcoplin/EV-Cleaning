...
<link rel=File-List href="README_filelist.xml">
<!--[if gte mso 9]><xml>
...
<link rel=themeData href="README_themedata.thmx">
...
<p class=MsoNormal>Checking the validity and other properties of sessions uses
...
causes, and trends can be done with the 'directory_cleaner' module, which can
...
<p class=MsoNormal>The 'visualize_profiles' module can plot and capture one or
many '.pkl' profiles in a directory using matplotlib.</p>
